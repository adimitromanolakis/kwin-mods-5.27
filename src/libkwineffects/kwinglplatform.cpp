...
{
    std::cout << "XXX9 detectRadeonClass = " << chipset.data() << "\n";
...
void GLPlatform::detect(OpenGLPlatformInterface platformInterface)
{
    ...
    std::cout << "XXX10 detect: m_renderer=" << m_renderer.data() << "\n";
    std::cout << "XXX10 detect: m_vendor=" << m_vendor.data() << "\n";
